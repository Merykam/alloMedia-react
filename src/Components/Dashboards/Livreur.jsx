  ...
  return (
    ...
    <div>
      <main className="profile-page">
        ...
        <div className="absolute top-0 w-full h-full bg-center bg-cover" style={{backgroundImage: `url('/src/assets/liv.jpg')`, backgroundSize:'cover'}}>
              ...
              <div className="px-6">
                <div className="flex flex-wrap justify-center">
                  <div className="w-full lg:w-3/12 px-4 lg:order-2 flex justify-center">
                    <div  className="realtive shadow-xl rounded-full h-auto align-middle border-none absolute -m-16 -ml-20 lg:-ml-16 max-w-150-px">
                      <img alt="..." src="/src/assets/gg.png" />
                    </div>
                  </div>
                ...
                <div className="mt-10 py-10 border-t border-blueGray-200 text-center">
                 ...
                 <button  className=" bg-sky-600 block w-full max-w-xs mx-auto hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-1 py-3 font-semibold"  onClick={handleLogout}>Logout</button>          </div>

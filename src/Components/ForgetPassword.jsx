...
const ForgetPassword = () => {
    ...
    const handleForgerPassword = async (e) => {
        e.preventDefault();

        try {
            console.log("hello");
            console.log(formData);
            const response = await axios.post('http://localhost:8000/api/auth/forgotPassword', formData);
  ...
  // return (
  //   <div>
  //     <form onSubmit={handleForgerPassword}>
  //       <input name='email' type="text" placeholder='Enter your email' onChange={handleInputChange}/>
  ...
  return (
    ...
    <div className="min-w-screen min-h-screen  flex items-center justify-center px-5 py-5">
        <div className="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden" style={{ maxWidth: '1000px' }}>
            ...
            <div className="hidden md:block w-1/2 bg-indigo-500 py-10 px-10" style={{backgroundImage: `url('/src/assets/liv.jpg')`, backgroundSize:'cover'}}>
                ...
                <div className="w-full md:w-1/2 py-10 px-5 md:px-10 bg-blue-200">
                    <div className="text-center mb-10">
                        <h1 className="font-bold text-3xl text-sky-900 ">Forget Password ?</h1>
                        ...
                        <div className="flex -mx-3">
                            <div className="w-full px-3 mb-12" >
                                ...
                                <div className="flex">
                                    ...
                                    <input name='email' type="text" onChange={handleInputChange} className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Enter your email"/>
                                </div>
                            </div>
